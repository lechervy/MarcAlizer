...
import fr.lip6.jdescriptors.texture.MacroGaborDescriptorCreator;
import fr.lip6.jdescriptors.texture.MacroGaborDescriptorCreator.Counting;
import fr.lip6.jdescriptors.texture.MacroGaborDescriptorCreator.Orientation;
...
public class MacroGaborIndexing {
	...
	static Option orientation = OptionBuilder.withArgName("invariance")
									.hasArg()
									.withDescription("orientation invariance method. Valid options are: none, mean, max, all (default none)")
									.withLongOpt("rotation")
									.create("r");
	static Option counting = OptionBuilder.withArgName("low level counting")
									.hasArg()
									.withDescription("counting method for low level feature construction. valid option are: lmean, max (default mean)")
	...
	public static void main(String[] args) throws IOException {
	    ...
	    try {
	        ...
	        if(line.hasOption("help"))
	        {
	        	...
	        	formatter.printHelp( "MacroGaborIndexing", options );
	        	System.exit(1);
	        }
	        //input
	        ...
	        String o = line.getOptionValue("r", "none");
	        ...
	        // low level counting
	        String c = line.getOptionValue("l", "mean");
